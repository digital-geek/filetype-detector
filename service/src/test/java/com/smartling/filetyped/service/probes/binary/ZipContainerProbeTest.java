...
public class ZipContainerProbeTest
{
    @Mock
    ...
    @InjectMocks
    private ZipContainerProbe probe;
    ...
    @Test
    public void returnsEmptyIfNotZip() throws Exception
    {
    ...
    @Test
    public void detectsUnsupportedZip() throws Exception
    {
        when(magicBytes.isPKZIP()).thenReturn(true);
