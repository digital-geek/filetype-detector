...
public class ResponseStatus<D>
{
    ...
    public ResponseStatus(ApiStatus status)
    {
        this(status, (String)null);
    }

    public ResponseStatus(ApiStatus status, List<String> messages)
    {
        this.code = status.toString();
        this.messages = messages;
    }

    public ResponseStatus(ApiStatus status, String message)
    {
        this.code = status.toString();
        if (message != null)
        {
